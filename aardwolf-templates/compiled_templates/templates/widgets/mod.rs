...
mod template_icon_2x;
pub use self::template_icon_2x::icon_2x;

mod template_icon_5x;
pub use self::template_icon_5x::icon_5x;
...
mod template_icon_normal;
pub use self::template_icon_normal::icon_normal;
...
mod template_icon_4x;
pub use self::template_icon_4x::icon_4x;
...
mod template_icon_lg;
pub use self::template_icon_lg::icon_lg;
...
mod template_icon_3x;
pub use self::template_icon_3x::icon_3x;
