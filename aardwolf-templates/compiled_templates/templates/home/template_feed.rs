...
out.write_all("</a> · <span class=\"fa fa-ellipsis-h\" aria-hidden=\"true\"></span> · 3 hrs</small>\n            </p>\n        </div>\n\n        <article class=\"media\">\n            <figure class=\"media-left\">\n                <p class=\"image is-48x48\">\n                <img src=\"https://bulma.io/images/placeholders/96x96.png\" alt=\"".as_bytes())?;
i18n!(catalog, "Username").to_html(out)?;
...
out.write_all("</a> · <a>".as_bytes())?;
i18n!(catalog, "Boost").to_html(out)?;
out.write_all("</a> · <span class=\"fa fa-ellipsis-h\" aria-hidden=\"true\"></span> · 2 hrs</small>\n                    </p>\n                </div>\n\n                <article class=\"media\">\n                    Vivamus quis semper metus, non tincidunt dolor. Vivamus in mi eu lorem cursus ullamcorper sit amet nec massa.\n                </article>\n\n                <article class=\"media\">\n                    Morbi vitae diam et purus tincidunt porttitor vel vitae augue. Praesent malesuada metus sed pharetra euismod. Cras tellus odio, tincidunt iaculis diam non, porta aliquet tortor.\n                </article>\n            </div>\n        </article>\n\n        <article class=\"media\">\n            <figure class=\"media-left\">\n                <p class=\"image is-48x48\">\n                <img src=\"https://bulma.io/images/placeholders/96x96.png\" alt=\"".as_bytes())?;
i18n!(catalog, "Username").to_html(out)?;
