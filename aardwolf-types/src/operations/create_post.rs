    ...
    G: GenerateUrls,
{
    ...
    fn db_action(self, conn: &mut PgConnection) -> Result<(BasePost, Post), CreatePostFail> {
...
mod tests {
    ...
    use aardwolf_test_helpers::models::{
        gen_string, make_verified_authenticated_user, user_make_base_actor, with_connection,
        UrlGenerator,
    };
