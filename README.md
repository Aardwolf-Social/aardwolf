...
The back-end is built on **Rust**. Technologies used for the front-end development are still being evaluated, but **Bootstrap 4** and **Rocket.rs** are currently in the lead.
